...
import { clearLocal, clearSession, getSession, removeLocal, removeSession } from '@/utils/storage';
import router from '@/router/index';
import { getLocal } from '@/utils/storage';

function createRequestHandle(api: string) {
  // 配置新建一个 axios 实例
...
export function toCreateService() {
  return new Promise((resolve, reject) => {
    if (getLocal('baseApi')) {
      const request = createRequestHandle(getLocal('baseApi'));
