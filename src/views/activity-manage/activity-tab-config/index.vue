<template>
  <div class="main-container">
    <crudOperation title="router.activity-tab-config" labelWidth="120px">
      <template #query>
        <el-form-item :label="$t('table.activity_tab')">
          <el-input
            v-model.trim="crudQuery.tab"
            clearable
            style="width: 200px"
          ></el-input>
        </el-form-item>
      ...
      <template #form>
        ...
        >
          ...
          >
            <el-input
              v-model.trim="proxyForm.tab"
              clearable
              :placeholder="$t('table.activity_tab')"
              style="width: 200px"
            ></el-input>
          </el-form-item>
          <el-form-item
...
<script lang="ts">
import Api from '@/api/activity-manage/activity-tab-config';
