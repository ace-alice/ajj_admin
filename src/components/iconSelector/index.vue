          ...
          <div v-if="isAllOn" class="icon-selector-all">
            ...
            <div class="icon-selector-all-tabs">
              <div
                ...
                :class="{
                  'icon-selector-all-tabs-active': fontIconTabsIndex === k
                }"
              >
            ...
            <el-row :gutter="10">
              ...
              >
                <div
                  ...
                  :class="{ 'icon-selector-active': fontIconIndex === k }"
                >
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const onColClick = (v: any, k: number) => {
      ...
      } else if (state.fontIconTabsIndex === 1) {
        state.fontIconPrefix = `ele ${v}`;
