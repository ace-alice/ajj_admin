<template>
  <div class="main-container">
    <crudOperation title="router.register-device-black-list">
      <template #query>
...
<script lang="ts">
import Api from '@/api/risk-control-config/register-device-black-list';
...
const defaultCrudOptions: CrudOptionsType = {
  ...
  crudTag: 'risk:register:device:'
};

export default defineComponent({
  name: 'register-device-black-list',
  ...
  setup() {
    ...
    const otherPermission = {
      //是否可以需改需要权限验证
      getLoginList: 'risk:register:device:getLoginList',
      forbid: 'risk:register:device:forbid'
    };
