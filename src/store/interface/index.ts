...
// 全局api配置
export interface GlobalApiConfigState {
  apiConfig: ConfigType<InternalName> | {};
}
...
export interface RootStateTypes {
  ...
  globalApiConfig: GlobalApiConfigState;
}
