<template>
  <div class="layout-navbars-breadcrumb" v-show="getThemeConfig.isBreadcrumb">
    <el-icon class="layout-navbars-breadcrumb-icon" @click="onThemeConfigChange"
      ><fold
    /></el-icon>
    <!-- <i
    ...
    <el-breadcrumb class="layout-navbars-breadcrumb-hide">
      <transition-group name="breadcrumb" mode="out-in">
        <el-breadcrumb-item v-for="(v, k) in breadcrumbList" :key="v.name">
          <span
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      // 自定义弹窗脚部关闭弹窗方法
      proxy.mittBus.on('onThemeConfigChange', () => {
