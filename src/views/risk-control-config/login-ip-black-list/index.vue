<template>
  <div class="main-container">
    <crudOperation title="router.login-ip-black-list">
      <template #query>
...
<script lang="ts">
import Api from '@/api/risk-control-config/login-ip-black-list';
...
const defaultCrudOptions: CrudOptionsType = {
  ...
  crudTag: 'risk:login:ip:'
};

export default defineComponent({
  name: 'login-ip-black-list',
  ...
  setup() {
    ...
    const otherPermission = {
      //是否可以需改需要权限验证
      getLoginList: 'risk:login:ip:getLoginList',
      forbid: 'risk:login:ip:forbid'
    };
